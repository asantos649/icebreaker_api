...
Question.create({text:'What is your perfect breakfast?'})
Question.create({text:'If you could have any exotic animal as a pet, which would you choose?'})
Question.create({text:'If you were a kitchen appliance or utensil, which would you be?'})
Question.create({text:'If you were a candy, which would you be?'})
